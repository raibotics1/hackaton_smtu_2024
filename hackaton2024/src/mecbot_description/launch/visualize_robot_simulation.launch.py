...
from scripts.gazebo_ros_paths import GazeboRosPaths  # Импортируем наш модуль
...
def launch_setup(context, *args, **kwargs):
  ...
  rviz_config_file = PathJoinSubstitution(
      [FindPackageShare("mecbot_description"), "rviz",
  ...
  robot_description_content = Command(
    [
      ...
      PathJoinSubstitution(
        [FindPackageShare("mecbot_description"), "urdf", "robot.xacro"]
      ),
      " ",
      "robot_type:=",
      robot_type,
  ...
  # gazebo node with specified world
